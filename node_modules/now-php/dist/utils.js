...
const lib_74_1 = require("@now-php/lib-74");
const PHP_PKG = path_1.default.dirname(require.resolve('@now-php/lib-74/package.json'));
...
async function getPhpFiles({ meta }) {
    const files = await lib_74_1.getLibFiles();
    if (meta && meta.isDev) {
...
async function getPhpLibFiles() {
    return await lib_74_1.getLibFiles();
}
